...
import UserParams from "./api/userparams";
      ...
      <HashRouter>
        <nav>
         {/* <Link to="/users" className="toplink">Users</Link>
          ...
          <Link to="/userapi/1" className="toplink text-decoration-none">UseParams</Link>
        </nav>
        <Routes>
         {/* <Route exact path="/users" element={<MyUser />} />
          ...
          <Route exact path="/userapi/:id" element={<UserParams/>}/>
        </Routes>
      </HashRouter>
    </UserProvider>
  );
